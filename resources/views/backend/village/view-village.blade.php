                                ...
                                <thead>
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td>{{$value->name}}</td>
                                      <td>
                                          <a title="edit" class="btn btn-primary btn-sm" href="{{route('villages.edit',$value->id)}}"><i class="fa fa-edit"> Edit</i></a>
                                          <a title="delete" id="delete" class="btn btn-danger btn-sm" href="{{route('villages.delete',$value->id)}}" ><i class="fa fa-trash"> Delete</i></a>
                                      </td>                      
                                    </tr>
                                    @endforeach
                                  </tbody>
